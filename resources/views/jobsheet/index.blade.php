                        ...
                        @foreach ($activeSpks as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('jobsheet.show', $item->id) }}" class="btn btn-success btn-sm shadow-sm font-weight-bold">
    ...
    <div class="card shadow mb-4 border-bottom-secondary">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped table-sm" id="dataTableSelesai" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        @foreach ($finishedSpks as $item)
                            <tr class="text-muted">
                                ...
                                <td class="text-center">
                                    <a href="{{ route('jobsheet.show', $item->id) }}" class="btn btn-secondary btn-sm shadow-sm">
