                            ...
                            @forelse ($spk as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('spk.show', $item->id) }}" class="btn btn-info btn-sm"
                                        ...
                                        @if(auth()->user()->isSuperAdmin())
                                            <a href="{{ route('spk.edit', $item->id) }}" class="btn btn-warning btn-sm"
                                                title="Edit">
                                            ...
                                            <form action="{{ route('spk.destroy', $item->id) }}" method="POST" class="d-inline">
                                                ...
                                                <button type="submit" class="btn btn-danger btn-sm"
                                                    onclick="return confirm('Yakin ingin menghapus SPK ini? Seluruh item di dalamnya juga akan terhapus.')"
                                                    title="Hapus">
