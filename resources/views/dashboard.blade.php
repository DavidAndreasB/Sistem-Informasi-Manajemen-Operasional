                        ...
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($spk->status == 'Diproses') <span class="badge badge-warning">Diproses</span>
                                        @elseif($spk->status == 'Selesai') <span class="badge badge-success">Selesai</span>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 small">
                        ...
                        <div>
                            ...
                            pada proyek <a href="{{ route('jobsheet.show', $job->spk_id) }}">{{ $job->spk->no_spk ?? '-' }}</a>.
                        </div>
                        <hr class="my-2">
                    </div>
                    @empty
                    ...
                    @endforelse
                    <a href="{{ route('jobsheet.index') }}" class="btn btn-light btn-block btn-sm">Lihat Semua Aktivitas &rarr;</a>
                </div>
            </div>
